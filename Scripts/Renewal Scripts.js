...
try
{
	...
	email("rprovinc@auroragov.org", "rprovinc@auroragov.org", "Debug" + recordID, "Debug: " + debug);
}
catch(e)
{
	email("rprovinc@auroragov.org", "rprovinc@auroragov.org", "Error" + recordID, e.message + " in Line " + e.lineNumber + br + "Stack: " + e.stack + br + "Debug: " + debug);
}
